// Free enroll endpoint
export const freeEnrollCourse = async (req, res) => {
  try {
    const userId = req.auth.userId;
    const { courseId } = req.body;
    if (!userId || !courseId) {
      return res.json({ success: false, message: 'Missing user or course.' });
    }
