      ...
      <div className='w-full mx-auto px-6 py-12 bg-gradient-to-b from-cyan-100/40'>
        ...
        <div className=' p-8 rounded-lg shadow-lg mb-8'>
          ...
          <p className='text-gray-600'>
            At Vibedemy, we strive to make education accessible and engaging for
            everyone. Our platform bridges the gap between students and
        ...
        <div className='mt-12 text-center'>
          ...
          <p className='text-gray-600 mb-6'>
            ...
            educator wanting to share knowledge, Vibedemy is the perfect
            platform for you.
          </p>
